...
public class StrKit {
	...
	public static boolean isEmpty(Object str) {
		return str == null || str == "" || str.toString().length() == 0;
	}
	 ...
	 * @return
	 */
	public static int getMapPageInt(Map<String,Object> reqMap, String name){
		int num = 0;
		return getMapPageInt(reqMap, name, num);
	}
	 ...
	 * @return
	 */
	public static int getMapPageInt(Map<String,Object> reqMap, String name,int num){
		try {
			if(reqMap.get(name)==null){
				return num;
			}
			if(isEmpty(reqMap.get(name).toString())){
				return num;
			}
			if(Integer.valueOf(reqMap.get(name).toString())<=0){
				return num;
			}
			num =  Integer.valueOf(reqMap.get(name).toString());
		}catch (Exception e){
		}
		return num;
	}
	 ...
	 * @return
	 */
	public static Long getMapPageLong(Map<String,Object> reqMap, String name){
		Long num = Long.valueOf(0);
		return getMapPageLong(reqMap, name, num);
	}
	/**
	 * 获取数组中的 int类型
	 * @param reqMap		数组
	 ...
	 * @return
	 */
	public static Long getMapPageLong(Map<String,Object> reqMap, String name,Long num){
		try {
			if(reqMap.get(name)==null){
				return num;
			}
			...
			if(Long.valueOf(reqMap.get(name).toString())<=0){
				return num;
			}
			num =  Long.valueOf(reqMap.get(name).toString());
		}catch (Exception e){
		}
		return num;
	}
	...
	public static boolean isEmpty(Map<String,Object> map, String str){
		try {
			...
			if(map.get(str).toString().length()==0){
				return true;
			}
		}catch (Exception e){
